...
void test_arm_and_run_motor_d(void) {
...
void setup() {
  ...
  Serial.println("\n\n>>> MOTOR D TEST STARTING <<<");
  
  UNITY_BEGIN();
  RUN_TEST(test_arm_and_run_motor_d);
  UNITY_END();
